...
class UserControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.List = channel.unary_unary(
                ...
                response_deserializer=account__pb2.Users.FromString,
                )
...
def add_UserControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'List': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=account__pb2.Users.SerializeToString,
            ),
...
class UserController(object):
    ...
    def List(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/account.UserController/List',
            account__pb2.UserListRequest.SerializeToString,
            account__pb2.Users.FromString,
